...
internal class Program {
    ...
    private static readonly bool useSigFilter = true;
    private static readonly string sigFilterExtra = "benign,not-provided";
    private static readonly int requestsPerSecond = 3;
    private static int cur_requestsPerSecond = 0;
    private static bool reuseDbFiles = true;
    private static bool checkForUpdates = true;
    private static readonly int returnMax = 1000;
    private static int done = 0;

    private static void Main(string[] args) {
        string[] raw_genome = File.ReadAllLinesAsync(filePath + "genome_Full_20250311210858.txt").Result;
